#!/usr/bin/env python3
"""
Quick training script using fallback data for fast iteration
"""
...
def generate_quick_data():
    ...
    for day in range(90):
        ...
        # Festival period (simplified)
        month = current_date.month
        is_festival = month in [3, 10, 11, 12]  # Holi, Diwali season
        ...
        for commodity in commodities:
            for i, market in enumerate(markets):
                ...
                elif month in [5, 6]:  # Sowing season
